...
sft_model_1.config.update({
    "use_cache": True,
    "pad_token_id": sft_model_1.config.eos_token_id 
})
...
sft_model_2.config.update({
    "use_cache": True,
    "pad_token_id": sft_model_2.config.eos_token_id 
})
sft_model_1 = prepare_model_for_peft(sft_model_1, peft_config=script_args.peft_config, args=script_args.training_args)
sft_model_1.load_adapter(script_args.dpo_model_1_name, "model_1")
sft_model_1.set_adapter("model_1")
sft_model_2 = prepare_model_for_peft(sft_model_2, peft_config=script_args.peft_config, args=script_args.training_args)
sft_model_2.load_adapter(script_args.dpo_model_2_name, "model_2")
sft_model_2.set_adapter("model_2")

sample_model = FusionModel([sft_model_1, sft_model_2], [script_args.weight_1, script_args.weight_2])
# tokenizer
